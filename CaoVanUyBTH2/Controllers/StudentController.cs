...
namespace CaoVanUyBTH2.Controllers
{
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StdID,StdName,Address")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("StdID,StdName,Address")] Student student)
        {
            if (id != student.StdID)
            {
                return NotFound();
                ...
                else
                {
                    ...
                    using (var stream = new FileStream(filePath, FileMode.Create))
                    {
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            std.StdName = dt.Rows[i][1].ToString();
